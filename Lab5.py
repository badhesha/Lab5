...
We then define a function for translating which envoles splitting the user input (sentence)
into an array of strings ("enjoy the excellent band tonight") ["enjoy", "the", "excellent", "band", "tonight"]

Once we have the arry of strings representing the user's input sentence, we
